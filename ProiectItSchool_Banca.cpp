...
int main()
{
	...
	int n = 0;
	cout << endl;
	cout << "\tBine ati venit !  Va rog sa va logati mai jos \n\n";
		do
		{
			cout << endl;
			cout << " Username: ";
			...
			cout << " Password: ";
			cin >> password;
			if (username == "ManagerConturi" && password == "manager")
			{
				cout << endl;
				cout << "\n Logare efectuata cu succes !\n\n";
				logare = true;
			}
			else
			{
				cout << endl;
				cout << " Parola incorecta, mai incercati !\n";
			}
		} while (!logare);
